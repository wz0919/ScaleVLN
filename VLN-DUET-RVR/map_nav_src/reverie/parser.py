...
def postprocess_args(args):
    ...
    ft_file_map = {
        ...
        # 'timm_vitb16': '../../../../data/img_features',
        'mmdet2d_frcnn_hm3d': 'obj_gtmax_mmdet2d_frcnn_hm3d/views',
        'clip-h14': 'clip_vit-h14_final.hdf5'
    }
    args.img_ft_file = os.path.join(ROOTDIR, 'R2R', 'features', ft_file_map[args.features])
    if not os.path.exists(args.img_ft_file):
        args.img_ft_file = os.path.join(ROOTDIR, 'R2R', 'features', ft_file_map[args.features])
    if args.features == 'timm_vitb16':
        args.img_ft_file = "/nvme/wangzun/vln/hm3d-vln/HM3DAutoVLN/datasets/R2R_hm3dautovln/features/view_timm_imagenet_vitb16"
    elif args.features == 'clip-h14':
        args.img_ft_file = "../datasets/R2R/features/clip_vit-h14_final.hdf5"
        args.aug_ft_file = "../datasets/R2R/features/clip_vit-h14_final.hdf5"
    ...
    args.obj_ft_file = "../datasets/REVERIE/features/obj_gtmax_timm_imagenet_vitb16"

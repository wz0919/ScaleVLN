...
def build_dataset(args, rank=0):
    ...
    if args.aug is not None:
        aug_obj_ft_file = os.path.join(
            os.environ['SCRATCH'],
            'datasets/REVERIE/features/yolov5m_objs365/obj_clip_vitb32_merged.hdf5'
        )
        print('load aug obj')
        aug_obj_db = ObjectFeatureDB(aug_obj_ft_file, args.obj_feat_size)
        ...
        aug_env = dataset_class(
            feat_db, aug_obj_db, aug_instr_data, args.connectivity_dir, obj2vps, 

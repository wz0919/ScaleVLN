...
def main(opts):
    ...
    trn_obj_ft_file = data_cfg.obj_ft_file
    # if 'auto_obj_ft_file' in data_cfg:
    #     trn_obj_ft_file = data_cfg.auto_obj_ft_file
    train_nav_db = ReverieTextPathData(
        data_cfg.train_traj_files, data_cfg.img_ft_file, trn_obj_ft_file,
